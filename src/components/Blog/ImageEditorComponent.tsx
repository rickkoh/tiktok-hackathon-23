  ...
  return (
    <div className="flex flex-col gap-2 w-full h-fit">
      {editing ? (
        <>
          <div
            className={`relative flex flex-col w-full rounded-lg border border-gray-300 ${
              imageSrc === undefined ? "h-32" : "h-fit"
            }`}
          >
            {imageSrc === undefined ? (
              <>
                <div className="w-full h-full rounded-lg flex flex-col gap-2 justify-center items-center text-gray-400">
